...
public:
    ...
    QPushButton *rotate_minus_y;
    QPushButton *rotate_plus_y;
    QPushButton *rotate_minus_x;
    QPushButton *rotate_plus_x;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        clockwiseButton->setGeometry(QRect(180, 60, 41, 31));
        ...
        anticlockButton->setGeometry(QRect(180, 110, 41, 31));
        anticlockButton->setCursor(QCursor(Qt::PointingHandCursor));
        rotate_minus_y = new QPushButton(groupBox_2);
        rotate_minus_y->setObjectName("rotate_minus_y");
        rotate_minus_y->setGeometry(QRect(100, 110, 41, 31));
        rotate_minus_y->setCursor(QCursor(Qt::PointingHandCursor));
        rotate_plus_y = new QPushButton(groupBox_2);
        rotate_plus_y->setObjectName("rotate_plus_y");
        rotate_plus_y->setGeometry(QRect(100, 60, 41, 31));
        rotate_plus_y->setCursor(QCursor(Qt::PointingHandCursor));
        rotate_minus_x = new QPushButton(groupBox_2);
        rotate_minus_x->setObjectName("rotate_minus_x");
        rotate_minus_x->setGeometry(QRect(20, 110, 41, 31));
        rotate_minus_x->setCursor(QCursor(Qt::PointingHandCursor));
        rotate_plus_x = new QPushButton(groupBox_2);
        rotate_plus_x->setObjectName("rotate_plus_x");
        rotate_plus_x->setGeometry(QRect(20, 60, 41, 31));
        rotate_plus_x->setCursor(QCursor(Qt::PointingHandCursor));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        clockwiseButton->setText(QCoreApplication::translate("MainWindow", "+z", nullptr));
        anticlockButton->setText(QCoreApplication::translate("MainWindow", "-z", nullptr));
        rotate_minus_y->setText(QCoreApplication::translate("MainWindow", "-y", nullptr));
        rotate_plus_y->setText(QCoreApplication::translate("MainWindow", "+y", nullptr));
        rotate_minus_x->setText(QCoreApplication::translate("MainWindow", "-x", nullptr));
        rotate_plus_x->setText(QCoreApplication::translate("MainWindow", "+x", nullptr));
